...
@section('title', 'Terms and Conditions | Shree Saurashtra Nagrik Sharafi Mandali Ltd.')
@section('meta', 'Terms governing the use of the Shree Saurashtra Nagrik Sharafi Sahakari Mandali Ltd. website.')

@section('content')
    <div class="page-head">
        <div class="wrap">
            <p class="crumb"><a href="{{ route('home') }}">Home</a> &rsaquo; Terms and Conditions</p>
    ...
    <section class="section">
        <div class="wrap">
            <div class="prose reveal">
                ...
                <h2>2. Not an Offer or Commitment</h2>
                ...
                <h2>9. Security and Fraud Warning</h2>
                ...
                <h2>10. Availability of the Website</h2>
