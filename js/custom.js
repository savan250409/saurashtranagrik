jQuery(document).ready(function($) {
    ...
    $('.navbar-collapse').addClass('navbar-collapse-hdie');
    $('.navbar-toggle').on('click', function() {
        if ($('.navbar-collapse').hasClass('navbar-collapse-hdie')) {
            $('.navbar-collapse').removeClass('navbar-collapse-hdie');
        } else {
            $('.navbar-collapse').addClass('navbar-collapse-hdie');
        }
    });
